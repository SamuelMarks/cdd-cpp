...
| **Operation Object (`schemes`)** | `[-]` , `[-]` | `[-]` , `[x]` | `[x]` , `[-]` | Dropped / Not converted to OAS3 |
...
| **Parameter Object (`collectionFormat`)** | `[-]` , `[-]` | `[-]` , `[x]` | `[x]` , `[-]` | Dropped / Not converted to OAS3 |
...
| **Items Object (`collectionFormat`)** | `[-]` , `[-]` | `[-]` , `[x]` | `[x]` , `[-]` | Dropped / Not converted to OAS3 |
...
| **Header Object (`collectionFormat`)** | `[-]` , `[-]` | `[-]` , `[x]` | `[x]` , `[-]` | Dropped / Not converted to OAS3 |
