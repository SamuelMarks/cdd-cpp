...
extern "C" {
    void* __cxa_allocate_exception(size_t thrown_size) noexcept { abort(); return nullptr; }
    ...
    void* __cxa_begin_catch(void *exceptionObject) noexcept { abort(); return nullptr; }
