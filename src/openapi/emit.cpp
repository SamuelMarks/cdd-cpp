...
void emit_Contact(utils::JsonWriter &jw,
                  const Contact &obj) noexcept { // GCOV_EXCL_LINE
...
void emit_License(utils::JsonWriter &jw,
                  const License &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();              // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_value("name", obj.name); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("identifier",
...
void emit_Server(utils::JsonWriter &jw,
                 const Server &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();            // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_XML(utils::JsonWriter &jw,
              const XML &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();                     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("name", obj.name);     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("namespace",
...
void emit_Schema(utils::JsonWriter &jw, const Schema &obj) noexcept {
  ...
  if (obj.properties != nullptr && // GCOV_EXCL_BR_LINE
    ...
    jw.start_object();             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] :
         *obj.properties) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.key(k);            // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_RequestBody(utils::JsonWriter &jw,
                      const RequestBody &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object(); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("description",
                  obj.description); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (!obj.content.empty()) {       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    ...
    jw.start_object();              // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] :
         obj.content) {      // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.key(k);             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_Link(utils::JsonWriter &jw,
               const Link &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object(); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("operationRef",
                  obj.operationRef); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("operationId",
                  obj.operationId); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_Response(utils::JsonWriter &jw,
                   const Response &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object(); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_value("description",
               obj.description); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.headers.has_value() &&
      !obj.headers->empty()) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  ...
  if (obj.content.has_value() &&
      !obj.content->empty()) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("content");         // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.start_object();         // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] :
  ...
  if (obj.links.has_value() &&
      !obj.links->empty()) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_Parameter(utils::JsonWriter &jw,
                    const Parameter &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();              // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_value("name", obj.name); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  ...
  if (obj.examples.has_value() &&
      !obj.examples->empty()) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_OAuthFlow(utils::JsonWriter &jw,
                    const OAuthFlow &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();                     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("authorizationUrl",    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
                  obj.authorizationUrl); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("tokenUrl",
                  obj.tokenUrl); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("refreshUrl",
                  obj.refreshUrl); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional(
      "deviceAuthorizationUrl",    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      obj.deviceAuthorizationUrl); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.scopes.has_value() &&
      !obj.scopes->empty()) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_OAuthFlows(utils::JsonWriter &jw,
                     const OAuthFlows &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();              // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_Operation(utils::JsonWriter &jw, const Operation &obj) noexcept {
  ...
  if (obj.callbacks != nullptr && // GCOV_EXCL_BR_LINE
    ...
    jw.start_object();            // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] :
         *obj.callbacks) {             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.key(k);                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.start_object();               // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
