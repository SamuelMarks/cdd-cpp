...
void emit_Contact(utils::JsonWriter &jw, const Contact &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();                   // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("name", obj.name);   // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("url", obj.url);     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("email", obj.email); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.end_object();                     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
} // GCOV_EXCL_LINE

void emit_License(utils::JsonWriter &jw, const License &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();                             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_value("name", obj.name);                // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("identifier", obj.identifier); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("url", obj.url);               // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.end_object();                               // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
} // GCOV_EXCL_LINE
...
void emit_Info(utils::JsonWriter &jw, const Info &obj) noexcept {
  ...
  if (obj.contact.has_value()) {                         // GCOV_EXCL_BR_LINE
    ...
    emit_Contact(jw, obj.contact.value());               // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  if (obj.license.has_value()) {           // GCOV_EXCL_BR_LINE
    jw.key("license");                     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    emit_License(jw, obj.license.value()); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  jw.key_value("version", obj.version); // GCOV_EXCL_BR_LINE
  jw.end_object();                      // GCOV_EXCL_BR_LINE
}

void emit_ServerVariable(utils::JsonWriter &jw, // GCOV_EXCL_LINE
                         const ServerVariable &obj) noexcept {
  jw.start_object();                                 // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.enum_values.has_value() &&                 // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      !obj.enum_values->empty()) {                   // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("enum");                                  // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.start_array();                                // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &item : obj.enum_values.value()) // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.value(item);                                // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.end_array();                                  // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  jw.key_value("default", obj.default_value);      // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("description", obj.description); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.end_object();                                 // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
} // GCOV_EXCL_LINE

void emit_Server(utils::JsonWriter &jw, const Server &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();                                   // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_value("url", obj.url);                        // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("description", obj.description);     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("name", obj.name);                   // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.variables.has_value() &&                     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      !obj.variables->empty()) {                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("variables");                               // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.start_object();                                 // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] : obj.variables.value()) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_ExternalDocumentation(utils::JsonWriter &jw, // GCOV_EXCL_LINE
                                const ExternalDocumentation &obj) noexcept {
  jw.start_object();                               // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("description", obj.description); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_value("url", obj.url);                    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_Tag(utils::JsonWriter &jw, const Tag &obj) noexcept {
  ...
  if (obj.externalDocs.has_value()) {              // GCOV_EXCL_BR_LINE
    ...
    emit_ExternalDocumentation(jw, // GCOV_EXCL_LINE
...
void emit_Discriminator(utils::JsonWriter &jw,
  ...
  if (obj.mapping.has_value() && !obj.mapping->empty()) { // GCOV_EXCL_BR_LINE
    ...
    jw.start_object();                                    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] : obj.mapping.value()) {      // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_XML(utils::JsonWriter &jw, const XML &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();                                  // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("name", obj.name);                  // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("namespace", obj.namespace_url);    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  ...
  if (obj.attribute.has_value())                      // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key_value("attribute", obj.attribute.value()); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.wrapped.has_value())                        // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key_value("wrapped", obj.wrapped.value());     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.end_object();                                    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
} // GCOV_EXCL_LINE
...
void emit_Schema(utils::JsonWriter &jw, const Schema &obj) noexcept {
  ...
  if (obj.ref.has_value()) {                             // GCOV_EXCL_BR_LINE
    jw.key_value("$ref", obj.ref.value().ref);           // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key_optional("summary", obj.ref.value().summary); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key_optional("description",                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  ...
  if (obj.properties != nullptr && // GCOV_EXCL_BR_LINE
    ...
    jw.key("properties");                        // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.start_object();                           // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] : *obj.properties) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.key(k);                                 // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      emit_Schema(jw, v);                        // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    } // GCOV_EXCL_LINE
    jw.end_object(); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  if (obj.items != nullptr) {    // GCOV_EXCL_BR_LINE
    jw.key("items");             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    emit_Schema(jw, *obj.items); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  jw.end_object(); // GCOV_EXCL_BR_LINE
}
...
void emit_Encoding(utils::JsonWriter &jw, const Encoding &obj) noexcept {
  ...
  if (obj.prefixEncoding != nullptr &&          // GCOV_EXCL_BR_LINE
...
void emit_RequestBody(utils::JsonWriter &jw, const RequestBody &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();                               // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("description", obj.description); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (!obj.content.empty()) {                      // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("content");                             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.start_object();                             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] : obj.content) {       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.key(k);                                   // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_Link(utils::JsonWriter &jw, const Link &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();                                  // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("operationRef", obj.operationRef);  // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("operationId", obj.operationId);    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.parameters.has_value() &&                   // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      !obj.parameters->empty()) {                     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("parameters");                             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.start_object();                                // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] : obj.parameters.value()) // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.key_value(k, v);                             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.end_object();                                  // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  jw.key_optional("requestBody", obj.requestBody); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("description", obj.description); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_Response(utils::JsonWriter &jw, const Response &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();                                      // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_value("description", obj.description);           // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.headers.has_value() && !obj.headers->empty()) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("headers");                                    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.start_object();                                    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] : obj.headers.value()) {      // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.key(k);                                          // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      emit_Header(jw, v);                                 // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    } // GCOV_EXCL_LINE
    jw.end_object(); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  if (obj.content.has_value() && !obj.content->empty()) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("content");                                    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.start_object();                                    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] : obj.content.value()) {      // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.key(k);                                          // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      emit_MediaType(jw, v);                              // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    } // GCOV_EXCL_LINE
    jw.end_object(); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  if (obj.links.has_value() && !obj.links->empty()) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("links");                                  // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.start_object();                                // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] : obj.links.value()) {    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.key(k);                                      // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_Parameter(utils::JsonWriter &jw, const Parameter &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();                               // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_value("name", obj.name);                  // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_value("in", obj.in);                      // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("description", obj.description); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.required)                                // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key_value("required", true);                // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.deprecated)                              // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key_value("deprecated", true);              // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.allowEmptyValue)                         // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key_value("allowEmptyValue", true);         // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  ...
  if (obj.explode.has_value())                     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key_value("explode", obj.explode.value());  // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.allowReserved.has_value())               // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key_value("allowReserved",                  // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  ...
  jw.key_optional("example", obj.example);                  // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.examples.has_value() && !obj.examples->empty()) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("examples");                                     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.start_object();                                      // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] : obj.examples.value()) {       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.key(k);                                            // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_OAuthFlow(utils::JsonWriter &jw, const OAuthFlow &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();                                    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("authorizationUrl",                   // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
                  obj.authorizationUrl);                // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("tokenUrl", obj.tokenUrl);            // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("refreshUrl", obj.refreshUrl);        // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("deviceAuthorizationUrl",             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
                  obj.deviceAuthorizationUrl);          // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.scopes.has_value() && !obj.scopes->empty()) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("scopes");                                   // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.start_object();                                  // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] : obj.scopes.value())       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.key_value(k, v);                               // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.end_object();                                    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  jw.end_object(); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_OAuthFlows(utils::JsonWriter &jw, const OAuthFlows &obj) noexcept { // GCOV_EXCL_LINE
  jw.start_object();                          // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.implicit.has_value()) {             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("implicit");                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    emit_OAuthFlow(jw, obj.implicit.value()); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  if (obj.password.has_value()) {             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("password");                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    emit_OAuthFlow(jw, obj.password.value()); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  if (obj.clientCredentials.has_value()) {             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("clientCredentials");                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    emit_OAuthFlow(jw, obj.clientCredentials.value()); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  if (obj.authorizationCode.has_value()) {             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("authorizationCode");                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    emit_OAuthFlow(jw, obj.authorizationCode.value()); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  if (obj.deviceAuthorization.has_value()) {             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("deviceAuthorization");                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    emit_OAuthFlow(jw, obj.deviceAuthorization.value()); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  jw.end_object(); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
} // GCOV_EXCL_LINE

void emit_SecurityScheme(utils::JsonWriter &jw, // GCOV_EXCL_LINE
                         const SecurityScheme &obj) noexcept {
  jw.start_object();                                 // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_value("type", obj.type);                    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("description", obj.description);   // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("name", obj.name);                 // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("in", obj.in);                     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("scheme", obj.scheme);             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("bearerFormat", obj.bearerFormat); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.flows.has_value()) {                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("flows");                                 // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    emit_OAuthFlows(jw, obj.flows.value());          // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  jw.key_optional("openIdConnectUrl",                    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
                  obj.openIdConnectUrl);                 // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("oauth2MetadataUrl",                   // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
                  obj.oauth2MetadataUrl);                // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  jw.key_optional("deprecated", obj.deprecated);         // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  if (obj.ref.has_value()) {                             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key_value("$ref", obj.ref.value().ref);           // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key_optional("summary", obj.ref.value().summary); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key_optional("description",                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_Operation(utils::JsonWriter &jw, const Operation &obj) noexcept {
  ...
  if (obj.tags.has_value() && !obj.tags->empty()) { // GCOV_EXCL_BR_LINE
    ...
    jw.start_array();                               // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &item : obj.tags.value())       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.value(item);                               // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.end_array();                                 // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  jw.key_optional("summary", obj.summary);         // GCOV_EXCL_BR_LINE
  ...
  if (obj.parameters.has_value() &&                 // GCOV_EXCL_BR_LINE
    ...
    jw.key("parameters");                           // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.start_array();                               // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &item : obj.parameters.value()) // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  ...
  if (obj.requestBody.has_value()) {               // GCOV_EXCL_BR_LINE
    ...
    emit_RequestBody(jw, obj.requestBody.value()); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  if (obj.responses.has_value() &&                     // GCOV_EXCL_BR_LINE
    ...
    jw.start_object();                                 // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] : obj.responses.value()) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.key(k);                                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      emit_Response(jw, v);                            // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    } // GCOV_EXCL_LINE
    jw.end_object(); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  if (obj.callbacks != nullptr &&               // GCOV_EXCL_BR_LINE
      !obj.callbacks->empty()) {                // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("callbacks");                        // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.start_object();                          // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] : *obj.callbacks) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.key(k);                                // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.start_object();                        // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      for (const auto &[ik, iv] : v) {          // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
        jw.key(ik);                             // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
        emit_PathItem(jw, iv);                  // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      } // GCOV_EXCL_LINE
      jw.end_object(); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    } // GCOV_EXCL_LINE
    jw.end_object(); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  ...
  if (obj.security.has_value() && !obj.security->empty()) { // GCOV_EXCL_BR_LINE
    ...
    jw.start_array();                                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &req : obj.security.value()) {          // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.start_object();                                    // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      for (const auto &[k, scopes] : req) {                 // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
        jw.key(k);                                          // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
        jw.start_array();                                   // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
        for (const auto &s : scopes)                        // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
          jw.value(s);                                      // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
        jw.end_array();                                     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      } // GCOV_EXCL_LINE
      jw.end_object(); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    } // GCOV_EXCL_LINE
  ...
  if (obj.servers.has_value() && !obj.servers->empty()) { // GCOV_EXCL_BR_LINE
    ...
    jw.start_array();                                     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &item : obj.servers.value())          // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
...
void emit_PathItem(utils::JsonWriter &jw, const PathItem &obj) noexcept {
  ...
  if (obj.delete_op.has_value()) {             // GCOV_EXCL_BR_LINE
    ...
    emit_Operation(jw, obj.delete_op.value()); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  if (obj.options.has_value()) {             // GCOV_EXCL_BR_LINE
    jw.key("options");                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    emit_Operation(jw, obj.options.value()); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  ...
  if (obj.patch.has_value()) {             // GCOV_EXCL_BR_LINE
    ...
    emit_Operation(jw, obj.patch.value()); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  if (obj.trace.has_value()) {             // GCOV_EXCL_BR_LINE
    jw.key("trace");                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    emit_Operation(jw, obj.trace.value()); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
...
void emit_Components(utils::JsonWriter &jw, const Components &obj) noexcept {
  ...
  if (obj.requestBodies.has_value() &&                     // GCOV_EXCL_BR_LINE
      !obj.requestBodies->empty()) {                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("requestBodies");                               // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.start_object();                                     // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] : obj.requestBodies.value()) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.key(k);                                           // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  ...
  if (obj.securitySchemes.has_value() && // GCOV_EXCL_BR_LINE
      !obj.securitySchemes->empty()) {   // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  ...
  if (obj.pathItems.has_value() &&                     // GCOV_EXCL_BR_LINE
      !obj.pathItems->empty()) {                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.key("pathItems");                               // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    jw.start_object();                                 // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    for (const auto &[k, v] : obj.pathItems.value()) { // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      jw.key(k);                                       // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
      emit_PathItem(jw, v);                            // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
    } // GCOV_EXCL_LINE
    jw.end_object(); // GCOV_EXCL_BR_LINE // GCOV_EXCL_LINE
  } // GCOV_EXCL_LINE
  if (obj.mediaTypes != nullptr &&               // GCOV_EXCL_BR_LINE
...
void emit_OpenAPI(utils::JsonWriter &jw, const OpenAPI &obj) noexcept {
  ...
  jw.key_optional("jsonSchemaDialect",                    // GCOV_EXCL_BR_LINE
