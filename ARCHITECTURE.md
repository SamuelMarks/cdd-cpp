...
[![Coverage](https://codecov.io/gh/offscale/cdd-cpp/branch/master/graph/badge.svg)](https://codecov.io/gh/offscale/cdd-cpp)
<!-- BADGES_END -->

The **cdd-cpp** tool acts as a dedicated compiler and transpiler. Its fundamental architecture follows standard compiler design principles, divided into three distinct phases: **Frontend (Parsing)**, **Intermediate Representation (IR)**, and **Backend (Emitting)**.
