...
| **ClientNotification** | `[x]` , `[x]` | `[-]` , `[-]` | `[x]` , `[x]` | Abstract concept |
| **ClientRequest** | `[x]` , `[x]` | `[-]` , `[-]` | `[x]` , `[x]` | Abstract concept |
| **ClientResult** | `[x]` , `[x]` | `[-]` , `[-]` | `[x]` , `[x]` | Abstract concept |
| **CompleteRequest** | `[x]` , `[x]` | `[-]` , `[-]` | `[-]` , `[-]` | |
...
| **JSONRPCMessage** | `[x]` , `[x]` | `[-]` , `[-]` | `[x]` , `[x]` | Abstract concept |
...
| **Notification** | `[x]` , `[x]` | `[-]` , `[-]` | `[x]` , `[x]` | `[-]` , `[-]` | `[x]` , `[x]` | Abstract concept |
...
| **Request** | `[x]` , `[x]` | `[-]` , `[-]` | `[x]` , `[x]` | `[-]` , `[-]` | `[x]` , `[x]` | Abstract concept |
...
| **ServerNotification** | `[x]` , `[x]` | `[-]` , `[-]` | `[x]` , `[x]` | Abstract concept |
| **ServerRequest** | `[x]` , `[x]` | `[-]` , `[-]` | `[x]` , `[x]` | Abstract concept |
| **ServerResult** | `[x]` , `[x]` | `[-]` , `[-]` | `[x]` , `[x]` | Abstract concept |
| **SetLevelRequest** | `[x]` , `[x]` | `[-]` , `[-]` | `[-]` , `[-]` | |
